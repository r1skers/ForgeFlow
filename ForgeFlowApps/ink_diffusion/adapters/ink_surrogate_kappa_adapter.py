...
class InkSurrogateKappaAdapter:
    """Adapter for one-step surrogate samples with kappa as conditioning feature."""

    name = "ink_surrogate_kappa_v1"
    required_fields = ("kappa", "h_t", "h_up", "h_down", "h_left", "h_right", "h_t1")
    infer_required_fields = ("kappa", "h_t", "h_up", "h_down", "h_left", "h_right")
    feature_names = ("kappa", "h_t", "h_up", "h_down", "h_left", "h_right")
    target_names = ("h_t1",)
