...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Build surrogate supervised train/infer datasets from ink diffusion trajectory. "
    ...
    parser.add_argument(
        "--train-out",
        type=Path,
        default=Path("ForgeFlowApps/ink_diffusion/data/processed/surrogate_train.csv"),
    ...
    print(f"[surrogate-data] grid={nx}x{ny}")
    print(f"[surrogate-data] train_rows={train_rows}")
    print(f"[surrogate-data] infer_rows={infer_rows}")
    print(f"[surrogate-data] train_file={args.train_out.resolve()}")
    print(f"[surrogate-data] infer_file={args.infer_out.resolve()}")
